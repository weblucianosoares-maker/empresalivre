...
const ApplicationForm: React.FC = () => {
  ...
  if (isSuccess) {
    const handleInstagramClick = () => {
      window.open('https://www.instagram.com/eufelipeguimaraes_/', '_blank');
    };
    ...
    return (
      <div className="bg-gray-900/90 border border-premium-green rounded-2xl p-10 text-center max-w-2xl mx-auto animate-fade-in">
        ...
        <Button onClick={handleInstagramClick} className="bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] hover:opacity-90 text-white border-none">
